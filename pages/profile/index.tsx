...
function Profile({ events = [], signOut, filters, eventOptions }: IProps) {
  ...
  return (
    <Authenticator components={authComponents} hideSignUp={true}>
      <nav className="bg-violet-800 p-2 mt-0 fixed w-full z-10 top-0 " style={{background:'#B746D7',borderBottomWidth:'3px', borderColor:'gray'}}>
      ...
      <div
        ...
        style={{borderWidth:'3px' ,background: '#eab8f8' }}
      >
        <div className=" break-words  mt-10  w-6/6 rounded-lg p-8 ">
          <div className="">
            <div className="" >
      ...
      <footer className="p-4   shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800"style={{background:'#B746D7',borderWidth:'3px', borderColor:'gray'}}>

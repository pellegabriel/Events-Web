    ...
    <div className=" hover:bg-black  flex justify-center" style={{ padding:'8px', marginBottom:'100px' ,  color:'gray-900', }}>
      <div className="mb-10  p-8" >
        ...
        {/* <div className="flex flex-col p-8 " >
          <h2 className=" text-sm text-white text-lg ">
            Tipo de evento:
          </h2>
          <Select
        ...
        />
          ...
          <h2 className="font-medium text-sm text-white text-lg ">Filtra entre los eventos existentes para encontrar el que mas te guste.</h2>
